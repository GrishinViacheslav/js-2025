...
if (confirm('Почати тестування?')) {
  ...
  function getLastPriceBiggerNum(prices,num=1000) {
    const lastPriceBiggerNum = prices.findLast((el) => el > num);
    return lastPriceBiggerNum
  }
  document.write(getLastPriceBiggerNum(securitiesPrices));
}
