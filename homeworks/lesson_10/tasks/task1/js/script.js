...
if (confirm('Почати тестування?')) {
  ...
  function getElBiggerThanNum(prices, num=1000) {
    const pricesBiggerNum = prices.filter((el) => el > num);
    return pricesBiggerNum
  }
  document.write(getElBiggerThanNum(securitiesPrices));
}
