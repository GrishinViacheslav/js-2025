...
if (confirm('Почати тестування?')) {
  ...
  function getSumPricesBiggerNum(prices,num=1000) {
    const pricesBiggerNumSum = prices.reduce((sum, el) => (el > num ? sum + el : sum), 0);
    return pricesBiggerNumSum
  }
  document.write(getSumPricesBiggerNum(securitiesPrices));
}
